 ...
 */
export interface BaseOuterProps<T> extends UseFieldConfig<T>, CommonBaseOuterProps<T> {}

/**
 * Base outer props for any field array. This contains FinalForm props as well as generic custom props.
 */
export interface BaseOuterArrayProps<T> extends UseFieldArrayConfig<T>, CommonBaseOuterProps<T> {}
