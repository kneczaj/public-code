...
import { Radio, FormControl, FormControlLabel, FormHelperText, RadioGroup, FormLabel } from "@material-ui/core";
...
export function RadioSelect({
  ...
  const t = useT();
  const { formControl, errorLabel } = useField<string[], HTMLInputElement, RadioProps>({
    ...config,
    type: 'radio'
  });
  return (
