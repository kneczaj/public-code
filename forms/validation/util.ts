 ...
 */
export type ValidatorFnSync = (value: any, values: FormValues) => ValidationResult
export type ValidatorFnAsync = (value: any, values: FormValues) => Promise<ValidationResult>;
...
export type Translator = (stringIdentifier: string, params?: {}) => string;
...
export const composeValidators = (
  ...
  for (let i = 0; i < functions.length; i++) {
    ...
    validationResult = isUndefined(validator) ? undefined : validator(value, values);
...
export const skipEmptyField: ValidatorFnDecorator = (fn: ValidatorFnSync) => (value: any, values: FormValues) => {
